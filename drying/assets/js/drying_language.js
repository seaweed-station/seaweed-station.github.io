...
const packs = {
  en: {
    ...
    text: {
      ...
      "print.blankHint": "Complete by hand. Circle the applicable location and drying configuration.",
  ...
  sw: {
    ...
    text: {
      ...
      "print.blankHint": "Jaza kwa mkono. Zungushia eneo na mpangilio wa ukaushaji unaotumika.",
