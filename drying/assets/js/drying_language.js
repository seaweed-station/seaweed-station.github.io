...
const packs = {
  en: {
    ...
    text: {
      ...
      "trials.summary": "Fixed schedule and completion tracker",
      "trials.batiTitle": "Bati trials",
      "trials.trial": "Trial",
      "trials.assignments": "Table configurations",
      "trials.dates": "Dates",
      "trials.complete": "Complete",
      "trials.save": "Save completion status",
      "trials.saving": "Saving completion status...",
      "trials.saved": "Completion status saved.",
      ...
      "trials.saveFailed": "Could not save completion status: {message}",
      ...
      "validation.bayEmpty": "Enter loading or unloading data for Bay {bay} before saving it.",
      "validation.phaseMissing": "Bay {bay}: enter the {field} to save this phase.",
  ...
  sw: {
    ...
    text: {
      ...
      "trials.summary": "Ratiba maalum na ufuatiliaji wa kukamilika",
      "trials.batiTitle": "Majaribio ya Bati",
      "trials.trial": "Jaribio",
      "trials.assignments": "Mipangilio ya meza",
      "trials.dates": "Tarehe",
      "trials.complete": "Imekamilika",
      "trials.save": "Hifadhi hali ya kukamilika",
      "trials.saving": "Inahifadhi hali ya kukamilika...",
      "trials.saved": "Hali ya kukamilika imehifadhiwa.",
      ...
      "trials.saveFailed": "Hali ya kukamilika haikuhifadhiwa: {message}",
      ...
      "validation.bayEmpty": "Weka taarifa za kupakia au kupakua kwa Bay {bay} kabla ya kuihifadhi.",
      "validation.phaseMissing": "Bay {bay}: weka {field} ili kuhifadhi sehemu hii.",
