...
const packs = {
  en: {
    ...
    text: {
      ...
      "reference.batiAlt": "Bati layout with the solar shed on the left, Tables 4 to 1 from left to right, and the road along the front",
      "reference.batiCaption": "With the road along the front, the solar shed is on the left and Tables 4, 3, 2 and 1 run from left to right.",
  ...
  sw: {
    ...
    text: {
      ...
      "reference.batiAlt": "Mpangilio wa Bati wenye banda la sola kushoto, Meza 4 hadi 1 kutoka kushoto kwenda kulia, na barabara upande wa mbele",
      "reference.batiCaption": "Barabara ikiwa upande wa mbele, banda la sola liko kushoto na Meza 4, 3, 2 na 1 zinafuatana kutoka kushoto kwenda kulia.",
